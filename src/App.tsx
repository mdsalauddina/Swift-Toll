...
const Card = ({
  ...
  <div id={id} className={`premium-card p-5 sm:p-8 ${className}`}>
    {title && (
      <h4 className="font-display font-bold text-slate-900 mb-6 tracking-tight text-lg sm:text-xl">
        {title}
      </h4>
    )}
    {children}
    ...
    {isOpen && (
      ...
      >
        ...
        <motion.div
          ...
          className="relative bg-white rounded-[24px] w-full max-w-lg overflow-hidden shadow-2xl flex flex-col max-h-[90vh]"
        >
          <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center sticky top-0 bg-white/80 backdrop-blur-md z-10 shrink-0">
            <h3 className="text-xl font-bold text-slate-900 font-display">
              {title}
            </h3>
            <button
              onClick={onClose}
              className="p-2 -mr-2 hover:bg-slate-100 rounded-full transition-colors flex shrink-0"
            >
        ...
        {balances.map((item) => (
          ...
          >
            ...
            <div className="text-right">
              <p
                className={`font-bold ${item.type === "recharge" ? "text-emerald-600" : "text-slate-900"}`}
              >
...
export default function App() {
  ...
  if (!isLoggedIn || viewMode === null) {
    return (
      <div className="min-h-[100dvh] bg-[#F9FAFB] flex items-center justify-center p-4 sm:p-6 font-sans relative overflow-hidden">
        ...
        >
          ...
          <Card
            id="login-card"
            className="shadow-2xl shadow-slate-200/50 p-6 sm:p-10 mb-6"
          >
  ...
  return (
    <div className="min-h-[100dvh] bg-[#F9FAFB] font-sans pb-24 sm:pb-20 pt-2 sm:pt-0">
      {/* Header */}
      <header className="glass-morphism sticky top-0 z-40 px-4 sm:px-6 py-3 sm:py-4 mb-6 sm:mb-8">
        <div className="max-w-6xl mx-auto flex justify-between items-center gap-2">
          <div className="flex items-center gap-3">
            <motion.div
              whileHover={{ rotate: 5 }}
              className="w-10 h-10 sm:w-12 sm:h-12 shrink-0 bg-slate-900 rounded-2xl flex items-center justify-center shadow-lg shadow-slate-200 overflow-hidden"
            >
              <img
                src="https://i.postimg.cc/L5ZtB5vr/1777431738491-2.jpg"
                alt="Logo"
            ...
            <div className="hidden lg:block shrink-0">
              <h2 className="font-display font-bold text-slate-900 leading-tight text-xl tracking-tight">
                SwiftToll
              </h2>
            ...
            {user?.role === "admin" && (
              <div className="ml-1 sm:ml-4 flex gap-1 bg-slate-100/90 p-1 rounded-[16px] border border-slate-200 overflow-x-auto hide-scrollbar">
                <button
                  onClick={() => setViewMode("user")}
                  className={`px-3 sm:px-4 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-wider transition-all whitespace-nowrap ${viewMode === "user" ? "bg-slate-900 text-white shadow-lg" : "text-slate-500 hover:text-slate-700"}`}
                >
                  <span className="hidden sm:inline">ইউজার</span> মোড
                </button>
                <button
                  onClick={() => setViewMode("admin")}
                  className={`px-3 sm:px-4 py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-wider transition-all whitespace-nowrap ${viewMode === "admin" ? "bg-slate-900 text-white shadow-lg" : "text-slate-500 hover:text-slate-700"}`}
                >
          ...
          <div className="flex items-center gap-2 sm:gap-4 shrink-0">
            ...
            <button
              ...
              className="p-2.5 text-slate-400 hover:text-rose-600 hover:bg-rose-50 rounded-2xl transition-all shrink-0"
              title="লগআউট"
            >
        ...
        {viewMode === "user" ? (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              >
                <Card
                  id="balance-card"
                  className="bg-white border-2 border-slate-200 overflow-hidden relative min-h-[240px] flex flex-col justify-between shadow-xl"
                >
                  ...
                  <div className="relative z-10 space-y-5">
                    <div className="flex justify-between items-end pt-6 border-t border-slate-100">
                      <div>
                        ...
                        <p className="font-bold tracking-wide text-lg text-slate-900">
                          {user?.name || "লোডিং..."}
                        </p>
                      </div>
                      <div className="text-right">
              ...
              <Card id="recharge-card" title="কুইক রিচার্জ">
                <form onSubmit={handleRecharge} className="space-y-4">
                  <div className="relative group">
                    <span className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-lg group-focus-within:text-slate-900 transition-colors">
                      ৳
                    </span>
                    <input
                      type="number"
                        ...
                        {activeTab === "travel" ? (
                          ...
                          balanceHistory.slice(0, 6).map((item, idx) => (
                            ...
                            >
                              <div className="flex items-center gap-5">
                                <div
                                  className={`w-12 h-12 rounded-2xl flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform ${item.type === "recharge" ? "bg-emerald-50 text-emerald-600" : "bg-slate-100 text-slate-500"}`}
                                >
                                  {item.type === "recharge" ? (
                              ...
                              <div className="text-right">
                                <p
                                  className={`font-display font-bold text-lg ${item.type === "recharge" ? "text-emerald-600" : "text-slate-900"}`}
                                >
                                  {item.type === "recharge" ? "+" : "-"}৳
                                  {item.amount}
                                </p>
          ...
          <div className="space-y-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              ...
              <div className="flex gap-1.5 bg-slate-200/50 p-1.5 rounded-2xl w-full md:w-auto overflow-x-auto hide-scrollbar">
                <button
                  onClick={() => setActiveAdminTab("requests")}
                  className={`shrink-0 px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${activeAdminTab === "requests" ? "bg-white text-slate-900 shadow-lg shadow-slate-200" : "text-slate-500 hover:text-slate-700"}`}
                >
                  অনুরোধ (
                ...
                <button
                  ...
                  className={`shrink-0 px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${activeAdminTab === "users" ? "bg-white text-slate-900 shadow-lg shadow-slate-200" : "text-slate-500 hover:text-slate-700"}`}
                >
                  ব্যবহারকারীগণ
                </button>
                <button
                  onClick={() => setActiveAdminTab("reports")}
                  className={`shrink-0 px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${activeAdminTab === "reports" ? "bg-white text-slate-900 shadow-lg shadow-slate-200" : "text-slate-500 hover:text-slate-700"}`}
                >
                  ইনকাম রিপোর্ট
                </button>
              </div>
                    ...
                    <table className="w-full text-left">
                      <thead>
                        <tr className="border-b border-slate-100 italic font-display">
                          <th className="py-5 font-semibold text-slate-400 text-xs uppercase tracking-widest px-4">
                            ব্যবহারকারী
                          </th>
                          <th className="py-5 font-semibold text-slate-400 text-xs uppercase tracking-widest px-4">
                            পরিমাণ
                          ...
                          <th className="py-5 font-semibold text-slate-400 text-xs uppercase tracking-widest px-4 text-right">
                            অ্যাকশন
                          </th>
                        </tr>
                      </thead>
                  ...
                  <div className="md:hidden space-y-3">
                    {adminRequests.map((item) => {
                      ...
                      return (
                        <div
                          key={item.id}
                          className="p-4 rounded-[20px] bg-slate-50 border border-slate-100 flex flex-col gap-3"
                        >
                          <div className="flex justify-between items-center">
                            <div>
                              <p className="font-display font-medium text-slate-900 text-sm">
                                {requestUser?.name || "Unknown"}
                              </p>
                          ...
                          <div className="flex justify-between items-center bg-white p-2.5 px-3 rounded-xl shadow-sm border border-slate-100/50">
                          ...
                          {item.status === "pending" && (
                            <div className="flex gap-2">
                              ...
                              <button
                                className="flex-1 bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 rounded-lg py-2 flex items-center justify-center gap-1 text-[11px] font-bold uppercase tracking-wider transition-colors"
                    ...
                    {users
                      ...
                      .map((u) => (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-5 gap-1.5 pt-2 border-t border-slate-200/50">
                            <button
                              onClick={() => {
                                setSelectedAdminUser(u);
                                setShowHistoryModal(true);
                              }}
                              className="flex flex-col items-center gap-1 p-2 bg-white rounded-xl shadow-sm border border-slate-100 text-indigo-600 transition-colors active:bg-slate-50"
                            >
                            ...
                            <button
                              onClick={() => handleDirectRecharge(u.id)}
                              className="flex flex-col items-center gap-1 p-2 bg-white rounded-xl shadow-sm border border-slate-100 text-emerald-600 transition-colors active:bg-slate-50"
                            >
                            ...
                            <button
                              onClick={() => handleAdjustBalance(u.id)}
                              className="flex flex-col items-center gap-1 p-2 bg-white rounded-xl shadow-sm border border-slate-100 text-amber-600 transition-colors active:bg-slate-50"
                            >
                            ...
                            <button
                              ...
                              className="flex flex-col items-center gap-1 p-2 bg-white rounded-xl shadow-sm border border-slate-100 text-slate-600 transition-colors active:bg-slate-50"
                            >
                          ...
                          .map((t) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <td className="py-5 px-4 font-display font-bold text-slate-900">
                                  ৳{t.amount}
                                </td>
